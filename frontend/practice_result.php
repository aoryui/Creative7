...
$_SESSION['result_display'] = 'practice_result';
    ...
    <table border="1" id="table">
        ...
        <?php foreach ($displayed_questions as $key => $question): ?>
            <tr>
                ...
                <td id="tri"><a href="practice_kaitoukaisetu.php?question_id=<?php echo $key; ?>">解説リンク</a></td>
                <td id="tri"><a href="practice_review.php?question_id=<?php echo $displayed_questions[$key]; ?>">復習リンク</a></td>
            </tr>
        <?php endforeach; ?>
    </table>
    </div>
