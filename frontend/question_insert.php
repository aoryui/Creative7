...
<head>
    ...
    <link rel="stylesheet" href="../css/question_insert.css"> <!-- CSSファイルの読み込み -->
</head>
<body>
    <!-- 「問題一覧」ページに遷移するボタン -->
    ...
    <script>
        ...
        function addChoice() {
            ...
            const placeholderLetter = String.fromCharCode(65 + optionCount); // A, B, C などを自動生成
            ...
            optionsDiv.appendChild(newOption); // 新しい選択肢を追加
        }
